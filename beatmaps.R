...
beatmaps$mode <- factor(beatmaps$mode, labels=c("Standard", "Taiko", "CtB", "Mania"))
std <- beatmaps[beatmaps$mode == "Standard",]
taiko <- beatmaps[beatmaps$mode == "Taiko",]
ctb <- beatmaps[beatmaps$mode == "CtB",]
mania <- beatmaps[beatmaps$mode == "Mania",]
